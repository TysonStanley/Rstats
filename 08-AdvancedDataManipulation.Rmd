...
It is also possible to do multiple measures at once when moving from wide to long or long to wide. The following figure shows the basics of the `reshape()` function that was made for an introductory R class.

![Reshape](https://github.com/TysonStanley/tysonstanley.github.io/blob/master/assets/images/DataCleaning_Handout.png)
