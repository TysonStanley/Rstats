...
df_long <- long(df_wide, 
                varying = c("Var_Time1", "Var_Time2"),
                v.names = "Var")
df_long
```
We provided the data (`df_wide`), the time varying variables (`varying = c("Var_Time1", "Var_Time2")`), and told it what we should name the value variable (`v.names = "Var"`). 
